...
import {
  ...
  SortEvent,
} from "./crop-one-listjs-sortable.directive";

@Component({
  selector: "app-crop-one-listjs",
...
export class CropListjsComponent {
  ...
  openSoilTypePopup(cropType: any): any {
    this.submitted = false;
    this.modalService.open(cropType, { size: "xl", centered: true });
  }
