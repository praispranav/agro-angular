...
import {
  ...
  SortEvent,
} from "./crop-three-listjs-sortable.directive";

@Component({
  selector: "app-crop-three-listjs",
...
export class CropListjsComponent {
  ...
  openYieldTypePopup(yieldType: any): any {
    this.submitted = false;
    this.modalService.open(yieldType, { size: "lg", centered: true });
  }
