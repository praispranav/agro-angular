...
import {
  ...
  SortEvent,
} from "./crop-five-listjs-sortable.directive";

@Component({
  selector: "app-crop-five-listjs",
...
export class CropListjsComponent {
  ...
  openMasterCropPopup(masterCrop: any): any {
    this.submitted = false;
    this.modalService.open(masterCrop, { size: "lg", centered: true });
  }
