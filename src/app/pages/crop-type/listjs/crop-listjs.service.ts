...
function sort(countries: CropListJsModel[], column: SortColumn, direction: string): CropListJsModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
export class CropService {
  ...
  getAll() {
    ...
    return this.http.get(`https://dev.endpoint.smartagrofarm.my/api/AppSetting/GetCropTypeList?displayStart=0&displayLength=10&SearchCropType=null`,{headers:headers});
}
